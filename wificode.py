...
def render_start(pard, rec):
	...
	h = '''
		...
		<div class="field is-grouped is-grouped-centered">
	  	  <div class="control">
    	    <button class="button is-dark" onclick="document.getElementById('wificodeForm').submit()">Stampa</button>
  		  </div>
	    </div>
	    </form>
		''' % rec
...
def render_preview(pard, rec):
	...
	h.append(bulma.img(pard,
			{'img_src': 'data:image/jpeg;base64,' + buf,
			 'img_class': 'is-square',
			}))
